...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof supabase === 'undefined') {
        console.error('Supabase client not loaded. Please check your network connection.');
        document.getElementById('loginError').textContent = 'Could not connect to authentication service. Please try again later.';
